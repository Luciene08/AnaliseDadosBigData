# import time ###sempre na primeira linha tem que importar a blibioteca que sera puxada a variável (time, radom, etc) ela da
...
dados_aleatorios = gerar_dados(200, 1, 100) # Gera 5 números entre 1 e 100
